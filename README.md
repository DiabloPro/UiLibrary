...
local slider = section:createSlider(name, range, default, precentage, callback) --[[ range is the range of numbers you want it should look like {0, 100}. 
Precentage should be true or false ]]--
```
